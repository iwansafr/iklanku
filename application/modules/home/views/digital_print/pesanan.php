	...
	<div id="produk">
		<?php if (!empty($data)): ?>
			<?php foreach ($data as $key => $value): ?>
				...
				<a href="<?php echo base_url('home/digital_print/pesanan_detail/'.$value['id']) ?>" >
					  ...
					  <div class="card-body">
							<div class="row">
								...
								<div class="col" style="margin: auto;">
									<span class="align-middle"><?= $param['Nama Produk'] ?></span>
									<br>
									<span class="v2"><?php echo $param['Nama Menu'] ?></span>
