...
<div class="container mt-5 pt-5 " id="pageSewa">
	...
	<?php if (!empty($data)): ?>
		...
		<?php if (empty($data['status_pembayaran'])): ?>
			...
			<a href='https://wa.me/<?php echo $meta['contact']['wa'] ?>?text=konfirmasi pembayaran digital print dengan kode <?php echo $data['kode']?>' class="btn btn-sm btn-success btn-lg text-white" id="submit" style="border-radius: 0.5rem;width: 100%;line-height: 8vw;font-size: 3.5vw;font-weight: bold;">
